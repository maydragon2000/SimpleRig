            ...
            <div className="terms">
                ...
                <div style={{ opacity: backgroundOpacity }}>
                    <div className="terms-header">
                        <div className="terms-header-top" style={{ display: isLogin ? "none" : "flex" }}>
                    ...
                    <div className="terms-content">
                        <div className="terms-content-inner">
                            <div className="first-part">
                                ...
                                <h3>5. CONTRACT TERM AND MINING TERM</h3>
                                ...
                                <h3>8. RESTRICTIONS AND OBLIGATIONS</h3>
                                ...
                                <h3>9. ADMINISTRATION OF MINING</h3>
                                ...
                                <h3>13. BREACH, SUSPENSION AND TERMINATION</h3>
                                ...
                                <h3>14. PAYMENT TERMS, ORDER CANCELLATION, ORDER CHANGES AND ORDER REFUNDS</h3>
