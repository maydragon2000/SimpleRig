...
const CreditCardCheck = () => {
    return (
        <>
            <div className="Check">
                <h1>CHECKOUT</h1>
                <div className="Check-inner row">
                    <div className="left col-6">
                        <div className="Check-inner-image-wrap">
                            <img alt="" src="image/pay1.png" />
                        </div>
                    ...
                    <div className="right col-6">
                        <h5 className="check-sub-title">WE ACCEPT CREDIT CARDS THROUGH </h5>
